...
public class MainActivity extends AppCompatActivity {
    ...
    private CustomReceiver mReceiver11 = new CustomReceiver();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button broadcastonButton = (Button) findViewById(R.id.onBroadcast);
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver
                (mReceiver11, new IntentFilter(CustomReceiver.ACTION_POWER_CONNECTED));
        ...
        broadcastonButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                setOnBroadcast();
            }
    ...
    protected void onDestroy() {
        ...
        LocalBroadcastManager.getInstance(this).unregisterReceiver(mReceiver11);
        super.onDestroy();
    }
    ...
    private void setOnBroadcast() {
        Intent power = new Intent(CustomReceiver.ACTION_POWER_CONNECTED);
        LocalBroadcastManager.getInstance(this).sendBroadcast(power);
    }
}
